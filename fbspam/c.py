...
enjoy it .Jjk 
email: cadow223@gmail.com
facebook: cabdulahi.sharif.100
githup: https://github.com/Cabdulahi
team:blackhat hackers'''
import sys
import os
import time
import bs4
...
class shit2:
  ...
  def mess(self):
      ...
      print
      self.sms= raw_input('[📝]Set Custom Message: ')
  ...
  def snd(self):
      print ('[🔨]Sending: '+self.sms + ' to '+self.id)
      self.act=('/messages/send/?icm=1')
      self.html2= {'fb_dtsg':self.fb1,'jazoest':self.fb2,'body':self.sms,'send':self.sub,self.cadow[0]:self.cadow[1]}
